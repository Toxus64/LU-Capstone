...
<?php
  ...
  $update = $conn->query("UPDATE inventory SET itemName = '$name', itemBrand = '$brand', itemColor = '$color', itemPrice = '$price', itemQuantity = '$quantity', itemMaxQuantity = '$maxQuantity' WHERE productID = '$id'");
